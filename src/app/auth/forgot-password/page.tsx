    ...
    <div style={{ minHeight: "100vh", background: T.bg, display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", fontFamily: "var(--font-dm-sans)" }}>
      <div style={{ width: "100%", maxWidth: "400px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "36px" }}>
          ...
          <p style={{ fontSize: "12px", color: T.text3, marginTop: "6px" }}>Reset your password</p>
        </div>
        ...
        <div style={{ background: T.bg2, border: `1px solid ${T.border}`, borderRadius: "16px", padding: "32px", boxShadow: "0 4px 24px rgba(28,23,16,0.06)" }}>
          ...
          {sent ? (
            <div>
              <div style={{ background: T.tealBg, border: `1px solid ${T.tealBd}`, borderRadius: "8px", padding: "14px 16px", marginBottom: "20px", fontSize: "13px", color: T.teal, lineHeight: "1.5" }}>
            ...
            <>
              <p style={{ fontSize: "13px", color: T.text2, marginBottom: "20px", lineHeight: "1.5" }}>
