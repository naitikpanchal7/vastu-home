    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === "primary" && "bg-gold text-bg hover:bg-gold-2",
          variant === "ghost" &&
            "bg-transparent text-vastu-text-2 border border-[rgba(200,175,120,0.15)] hover:text-vastu-text hover:border-gold-3",
          variant === "danger" &&
